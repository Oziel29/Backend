...
3. Ejecuta la aplicación con las teclas "Mayus+F10" o con el botón ![img.png](gradle/img/img.png)
...
6. Una vez en la pantalla "Crear Cuenta", se deberá ingresar un el usuario y contraseña deseados para la cuenta, una vez hecho esto, se deberá presionar el botón verde para crear la cuenta.
